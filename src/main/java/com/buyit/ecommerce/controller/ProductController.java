...
import com.buyit.ecommerce.dto.request.product.CreateProductImagesRequest;
...
public class ProductController {
    ...
    public ApiResponse<Void> addImagesToProduct(@PathVariable("id") Long id,
                                                @Valid @ModelAttribute CreateProductImagesRequest images) throws IOException {
        return productImageService.uploadProductImage(images.getImages(), id);
    }
